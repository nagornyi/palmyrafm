...
# Template: app
# Command: /usr/bin/qmake6 -o Makefile palmyrafm.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = palmyrafm1.0.0
DISTDIR = /home/artem/repo/palmyrafm/.tmp/palmyrafm1.0.0
LINK          = g++
...
Makefile: palmyrafm.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents palmyrafm.h dirview.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp palmyrafm.cpp dirview.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_palmyrafm.cpp moc_dirview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_palmyrafm.cpp moc_dirview.cpp
moc_palmyrafm.cpp: palmyrafm.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/artem/repo/palmyrafm/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/artem/repo/palmyrafm -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include palmyrafm.h -o moc_palmyrafm.cpp

moc_dirview.cpp: dirview.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/artem/repo/palmyrafm/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/artem/repo/palmyrafm -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include dirview.h -o moc_dirview.cpp
...
palmyrafm.o: palmyrafm.cpp palmyrafm.h \
		dirview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o palmyrafm.o palmyrafm.cpp

dirview.o: dirview.cpp dirview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dirview.o dirview.cpp

moc_palmyrafm.o: moc_palmyrafm.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_palmyrafm.o moc_palmyrafm.cpp
